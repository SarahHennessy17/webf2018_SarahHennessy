...
slider.oninput = function() {
 ...
 //    $(".other").css('width', newData["other"] + "vw");
    ...
    $(".white").css('font-size', newData["white"] + "vh");
    $(".black").css('font-size', newData["black"] + "vh");
    $(".latino").css('font-size', newData["latino"] + "vh");
    $(".asian").css('font-size', newData["asian"] + "vh");
    $(".other").css('font-size', newData["other"] + "vh");
